...
fn parse_bofa_card_format(
    ...
    for result in rdr.records() {
        ...
        // When the cardholder name contains commas (e.g. "BLUEPEAK DESIGN, LLC"),
...
";
    ...
    fn test_bofa_credit_card_parse_comma_in_name() {
        ...
        // Header has 11 fields; data rows with "BLUEPEAK DESIGN, LLC" produce 12 fields
        let content = "\
...
BLUEPEAK DESIGN, LLC,1234,01/16/2025,01/16/2025,-75.50,Travel,DELTA AIRLINES,456 Airport Rd,Atlanta GA,REF002,D
...
BLUEPEAK DESIGN, LLC,5678,02/01/2025,02/01/2025,-1000.00,Transfer,LINE OF CREDIT DRAW,100 Bank St,Boston MA,REF101
...
CardHolder Name,Account Number,Transaction Date,Posting Date,Amount,Category,Payee,Address,City/State,Reference Number,Type
BLUEPEAK DESIGN LLC,1234,01/15/2025,01/15/2025,-50.00,Shopping,AMAZON PURCHASE,123 Main St,Seattle WA,REF001,D
BLUEPEAK DESIGN LLC,1234,01/16/2025,01/16/2025,NOT_A_NUMBER,Food,RESTAURANT,456 Elm St,Portland OR,REF002,D
