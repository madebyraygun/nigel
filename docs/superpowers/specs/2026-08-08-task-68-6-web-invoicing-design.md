...
│ └─────────────────────────────────────────────────────────────────────────┘│
│ ┌── Payments ────────────┐ ┌── Published ──────────────────────────────────┐│
│ │ (none yet)             │ │ https://billing.example.com/i/aBc123…/    [copy]  ││
...
│   • publish the invoice to billing.example.com                    │
...
6. **Send subject line.** `send.rs` hardcodes `format!("Invoice #{} from
   Bluepeak", invoice.number)`. Every other product string is configurable and
