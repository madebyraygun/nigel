...
src/
  ...
  cli/                  # CLI subcommands
    ...
    client.rs           # nigel client add/list/show/edit/delete/archive/unarchive
    client_manager.rs   # TUI client screen (list, add, edit, delete, archive)
