...
src/
  ...
  server/               # Web server (feature-gated behind "serve")
    ...
    routes/
      ...
      clients.rs        # GET /api/clients, GET /api/clients/:id
      invoices.rs       # GET /api/invoices, /api/invoices/:number(+/preview[.pdf]), /aging, /next-number
