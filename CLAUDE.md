...
src/
  ...
  cli/                  # CLI subcommands
    ...
    invoice.rs          # nigel invoice new/edit/void/list/show/preview/send/sync/pay/aging/import
  ...
  invoicing/            # Invoicing (A/R): clients, invoices, publish, email, payment sync
    ...
    render_html.rs      # Invoice HTML rendering ({{KEY}} template expansion, PayButton)
