...
Bluepeak Bookkeeper — a Claude-powered bookkeeping system replacing QuickBooks for Bluepeak. Cash-basis, single-entry accounting with bank CSV imports, rules-based categorization, and SQLite storage. See `raygun-bookkeeper-plan.md` for the full system plan.
