...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [x] #1 Both documents render every figure — line items and money block — in one currency-aware format: separators, two decimals, a symbol for USD and a code prefix otherwise
<!-- AC:END -->
