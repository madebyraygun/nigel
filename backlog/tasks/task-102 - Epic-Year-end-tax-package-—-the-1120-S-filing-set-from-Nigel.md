...
Ordering is roughly the numbering, with one thing ahead of it: **TASK-9.1 (account classification) lands first**, because both the balance sheet and the equity treatment classify from it. TASK-102.1 and TASK-102.2 then unlock TASK-102.3; the rest are independent and can be picked up in any order. TASK-102.9 is the capstone and should land last.
...
## Acceptance Criteria
<!-- AC:BEGIN -->
- [ ] #1 TASK-102.1 through TASK-102.9 are Done, and TASK-9.1, TASK-45 and TASK-46 are Done as prerequisites
...
- [ ] #3 The 2025 books reproduce the as-filed 2025 return through `nigel report taxpackage --year 2025`, and any discrepancy is explained
- [ ] #4 The Claude skills in `.claude/skills/` reference the new commands and tax-aware categories, and `docs/skills.md` matches
- [ ] #5 **IMPORTANT**: Any PRs created from this epic must be created as DRAFTS until manually reviewed by the user
<!-- AC:END -->
